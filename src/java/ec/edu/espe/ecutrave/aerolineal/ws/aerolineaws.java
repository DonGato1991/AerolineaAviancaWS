 ...
 */
@WebService(serviceName = "aerolineaAviancaws")
//aerolineaAviancaws juan
public class aerolineaws {
    ...
    private boolean insertVueloByParam(
            ...
            @WebParam(name = "aerolinea") String aerolinea,
        ...
        for (int i = 0; i < 30; i++) {
            ...
            for (int j = 0; j < 5; j++) {
                ...
                vuelo.setPrecio(new BigDecimal(precio));
                vuelo.setCiudadOrigen(origen.toUpperCase());
                vuelo.setCiudadDestino(destino.toUpperCase());
                vuelo.setAerolinea(aerolinea.toUpperCase());
